...
- You may upgrade your package after the updates by doing this: _pip install YOURPACKAGENAME --upgrade
- You can always find your package on PyPi here: ht<span>tp://</span>https://pypi.org/project/YOURPACKAGENAME/
